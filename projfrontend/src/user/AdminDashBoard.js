...
const AdminDashBoard=()=>{
    ...
    const {user: { name, email, role }} = isAutheticated();  //we destructure.isAuthenticated gives you user and from user we can get name,email.....

  const adminLeftSide = () => {  //designing 2 fcns
    return (
      <div className="card">   
  ...
  const adminRightSide = () => {// badge class was not working therefore we used alert
    return (
